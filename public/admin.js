...
const AppNav = () => (
  <nav class="navbar navbar-dark bg-dark">
    ...
    <a role="button" class="btn btn-outline-info navbar-btn" href="/logout">
      Logout
    </a>
  </nav>
);
...
class Admin extends React.Component {
  ...
  componentDidMount() {
    console.log("TCL: Admin -> componentDidMount -> componentDidMount");
  ...
  render() {
    return (
      <div>
        ...
        <button
          type="button"
          class="mt-4 mb-2 btn btn-primary btn-sm float-right"
